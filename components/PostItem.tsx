...
import { PencilAltIcon,TrashIcon, ExclamationCircleIcon, UserCircleIcon } from "@heroicons/react/solid";
...
export const PostItemMemo:FC<Omit<Post, 'created_at'>> = ({
    ...
    return (
        <>
            <li className="w-80">
                <div className="my-3 w-full border border-dashed bordeer-gray-400" />
                <div className="flex items-center justify-between">
                    <div className="flex">
                        {avatarUrl ?(
                            ...
                            <UserCircleIcon className="inline-block h-8 w-8 cursor-pointer text-fray-500"/>
                        )}
